...
# -*- coding: utf-8 -*-
#
# jASH documentation build configuration file, created by
# sphinx-quickstart on Mon Dec  7 11:53:09 2020.
#
...
html_logo= 'figures/jash-simple-logo.png'
html_theme_options = {
    'canonical_url': '',
...
latex_documents = [
    (master_doc, 'jASH.tex', 'jASH Documentation',
...
man_pages = [
    (master_doc, 'jash', 'jASH Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jASH', 'jASH Documentation',
     author, 'jASH', 'One line description of project.',
     'Miscellaneous'),
]
